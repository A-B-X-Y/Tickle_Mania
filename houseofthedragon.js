function ep1(){
    ...
    for (var i = 0; i < videoEls.length; i++) {
        videoEls[i].src = "https://dood.wf/e/5mvzi7ntza8tplre3ul6sv8uagk783rm";
    };
...
function ep2(){
    var videoEls = document.getElementsByTagName("iframe");
    for (var i = 0; i < videoEls.length; i++) {
        videoEls[i].src = "https://dood.wf/e/68vqdn6ijn66lh6xub1visnamu46q8uc";
    };
...
function ep3(){
    var videoEls = document.getElementsByTagName("iframe");
    for (var i = 0; i < videoEls.length; i++) {
        videoEls[i].src = "https://dood.wf/e/qsxtyegmho5vcwe7o835drd2o9kao1dc";
    };
...
function ep4(){
    var videoEls = document.getElementsByTagName("iframe");
    for (var i = 0; i < videoEls.length; i++) {
        videoEls[i].src = "https://dood.wf/e/w78vr6s28ljtirfvrf7iijezqwlpwgf9";
    };
...
function ep5(){
    var videoEls = document.getElementsByTagName("iframe");
    for (var i = 0; i < videoEls.length; i++) {
        videoEls[i].src = "https://dood.wf/e/6obnr4dzf0s2mlf3znc1m97lgfxj1dst";
    };
...
function ep6(){
    var videoEls = document.getElementsByTagName("iframe");
    for (var i = 0; i < videoEls.length; i++) {
        videoEls[i].src = "https://dood.wf/e/vhtm9ug3fp3b8rxs90scjqkc4i893akx";
    };
...
function ep7(){
    var videoEls = document.getElementsByTagName("iframe");
    for (var i = 0; i < videoEls.length; i++) {
        videoEls[i].src = "https://dood.wf/e/fphgb29y952wnieorzpo9j9hx8tnip3s";
    };
...
function ep8(){
    var videoEls = document.getElementsByTagName("iframe");
    for (var i = 0; i < videoEls.length; i++) {
        videoEls[i].src = "https://dood.wf/e/narad7nxrrvgrufhp0t6w498r9ci6b2z";
    };
...
function eph1(){
    var videoEls = document.getElementsByTagName("iframe");
    for (var i = 0; i < videoEls.length; i++) {
        videoEls[i].src = "https://dood.wf/e/7vxj5f7pidhdsvrv3toj8nf3s7mwy4x8";
    };
...
function eph2(){
    var videoEls = document.getElementsByTagName("iframe");
    for (var i = 0; i < videoEls.length; i++) {
        videoEls[i].src = "https://dood.wf/e/84gnf3a1r6ozf6yquhg5p5ahjdhbp81t";
    };
...
function eph3(){
    var videoEls = document.getElementsByTagName("iframe");
    for (var i = 0; i < videoEls.length; i++) {
        videoEls[i].src = "https://dood.wf/e/indpe4j2zi5vznwcqtv85dg4z9to5ita";
    };
...
function eph4(){
    var videoEls = document.getElementsByTagName("iframe");
    for (var i = 0; i < videoEls.length; i++) {
        videoEls[i].src = "https://dood.wf/e/p85035ulqc15skeaa6kpixkacfixljha";
    };
...
function eph5(){
    var videoEls = document.getElementsByTagName("iframe");
    for (var i = 0; i < videoEls.length; i++) {
        videoEls[i].src = "https://dood.wf/e/f2naasb3sknb6nosx70iq0hovjy6te9w";
    };
...
function eph6(){
    var videoEls = document.getElementsByTagName("iframe");
    for (var i = 0; i < videoEls.length; i++) {
        videoEls[i].src = "https://dood.wf/e/ss5u87eyldc9r6l8dgd2ve1w8j9ylwc2";
    };
...
function eph7(){
    var videoEls = document.getElementsByTagName("iframe");
    for (var i = 0; i < videoEls.length; i++) {
        videoEls[i].src = "https://dood.wf/e/jp6j6733n64hkb2htpmqnoe7p0tm2pmy";
    };
...
function eph8(){
    var videoEls = document.getElementsByTagName("iframe");
    for (var i = 0; i < videoEls.length; i++) {
        videoEls[i].src = "https://dood.wf/e/2u6e03g66gvky1ouq72tt3rz6992lgsy";
    };
